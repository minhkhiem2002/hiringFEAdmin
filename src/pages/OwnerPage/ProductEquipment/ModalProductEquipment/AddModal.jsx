...
import TagBox from 'devextreme-react/tag-box'; // Sử dụng TagBox cho MultiSelect
import {
  fetchColorsRequest,
  fetchCategoriesRequest,
  fetchSizesRequest,
} from '../../../../redux/actions/Owner/FilterProductActions';
import { postProductRequest } from '../../../../redux/actions/Owner/productActions';
...
const AddModal = ({ openAddModal, setOpenAddModal }) => {
  ...
  const { categories: categoryData } = useSelector((state) => state.filterProduct);
  ...
  const handleSubmit = () => {
    ...
    dispatch(postProductRequest(formDataToSubmit));
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <SelectBox
              ...
              onValueChanged={(e) => handleInputChange('CategoryId', e.value)}
              displayExpr="name"
              valueExpr="id"
