...
import { deleteProductRequest } from "../../../../redux/actions/Owner/productActions";
...
function DeleteModal(props) {
  ...
  const handleDelete = () => {
    dispatch(deleteProductRequest(infoDetail.sportProductId))
    setOpenDeleteModal(false);
  };
  ...
  >
    <DialogTitle id="customized-dialog-title">Xóa thiết bị</DialogTitle>
    <IconButton
      aria-label="close"
      onClick={hidePopup}
      sx={{
